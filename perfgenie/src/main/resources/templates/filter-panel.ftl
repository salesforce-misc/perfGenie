...
<script type="text/javascript" class="init">
    ...
    function getStackTrace(stackid, eventType, code, timestamp) {
        ...
        stacktrace = stacktrace + getProfileName(sampleType) + ((jstackidcolorsmap[code] != undefined) ? " " + jstackidcolorsmap[code] : "") + ((timestamp != undefined) ? " " + moment.utc(timestamp).format('YYYY-MM-DD HH:mm:ss') : "") + "\n\n";
